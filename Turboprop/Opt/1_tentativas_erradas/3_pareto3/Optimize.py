...
def main():
    ...
    for i, beta in enumerate(betas):
        ...
        design_vars[-1] = beta
        design_vars[0] = 61. * 1.2
        design_vars[1] = 12  * 1.2
        design_vars[2] = 0.15 * 0.9
        design_vars[3] = 3. * 1.2
...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      61., (50.0, 72.0),   100., Units.meter**2],
        ['aspect_ratio',   12.,   (10., 14.),  100.0,     Units.less],
        ['t_c_ratio',     0.15, (0.11, 0.18),     1.,     Units.less],
        ['sweep_angle',     3.,   (0.,  10.0),  100.0,      Units.deg],
        # ['taper_ratio',   0.53, (0.53, 0.53),     1.,     Units.less],
        ['cruise_range', 331.3, (280., 370.), 1000.0, Units.nautical_miles],
        ['delta_fuel',     8.8, (0., 350.),   1000.0,       Units.kg],  # MTOW consistency
