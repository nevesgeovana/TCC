...
def base_setup():
    ...
    vehicle.mass_properties.max_zero_fuel             = 21000. * Units.kg
    ...
    vehicle.delta_fuel = 8.8 * Units.kg
    ...
    gas_turbine.power_scaling_factor  = [0.622, 0.696*1.06, 0.74*1.015]  # NTO, MCL, MCR 0.601
