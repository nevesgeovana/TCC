...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',       61.*1.1, (50.0, 72.0),   61.,       Units.meter**2],
        ['aspect_ratio',    12.*1.1,   (10., 14.),  12.0,           Units.less],
        ['t_c_ratio',      0.15*1.1, (0.11, 0.18),  0.15,           Units.less],
        ['cruise_range',  331.3, (310., 350.), 331.3, Units.nautical_miles],
        ['MTOW',         23000.*1.1, (21000., 25000.), 23000.,        Units.kg],
        ['MZFW_ratio',    0.913, (0.8, 0.98),        0.92,      Units.less],
    ])
