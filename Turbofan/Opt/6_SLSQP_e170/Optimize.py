...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      72.72,  (65.0, 80.0),       75.,       Units.meter**2],
        ['aspect_ratio',     8.6,    (7.6, 9.8),       9.8,           Units.less],
        ['t_c_ratio',       0.11,  (0.09, 0.15),      0.13,           Units.less],
        ['sweep_angle',      23.,  (18.0, 30.0),      30.0,            Units.deg],
