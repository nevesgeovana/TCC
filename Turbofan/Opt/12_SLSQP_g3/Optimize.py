...
def setup():
    ...
    problem.inputs = np.array([
        ...
        ['cruise_range', 1118.87701981, (1000., 1160.),   1130.0, Units.nautical_miles],
        ['MTOW',          37041.993124, (35000., 39000.), 37200.,             Units.kg],
        ['MZFW_ratio',     0.816265315, (0.7, 0.9),          0.9,           Units.less],
    ])
