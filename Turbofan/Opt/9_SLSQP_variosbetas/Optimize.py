...
def main():
    ...
    betas = [0.95,0.9,0.85,0.8,0.7,0.65,0.6,0.55,0.45,0.4,0.35,0.3,0.2,0.15,0.1]
...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      72.72*1.1,  (65.0, 80.0),       75.,       Units.meter**2],
        ['aspect_ratio',     8.6*1.1,    (7.6, 9.8),       9.8,           Units.less],
        ['t_c_ratio',       0.11*1.1,  (0.09, 0.15),      0.13,           Units.less],
        ['sweep_angle',      23.*1.1,  (18.0, 30.0),      30.0,            Units.deg],
