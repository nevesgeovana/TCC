...
def main():
    ...
    betas = [0.95,0.9,0.8,0.6,0.4,0.2,0.15,0.1,0.05,0.]
...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      75.86117927,  (65.0, 80.0),       75.,       Units.meter**2],
        ['aspect_ratio',           9.8,    (7.6, 9.8),       9.8,           Units.less],
        ['t_c_ratio',      0.115453132,  (0.09, 0.15),      0.13,           Units.less],
        ['sweep_angle',            30.,  (18.0, 30.0),      30.0,            Units.deg],
        ['cruise_range', 1118.26926787, (1000., 1160.),   1130.0, Units.nautical_miles],
        ['MTOW',         37767.5355283, (35000., 39000.), 37200.,             Units.kg],
        ['MZFW_ratio',     0.821104594, (0.7, 0.9),          0.9,           Units.less],
    ])
