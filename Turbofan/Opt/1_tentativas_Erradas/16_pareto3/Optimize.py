...
def main():
    ...
    for i, beta in enumerate(betas):
        ...
        design_vars[-1] = beta
        design_vars[0] = 72.72 # * (beta * 1.025 + (1 - beta) * 0.97)
        design_vars[1] = 8.6   # * (beta * 1.15  + (1 - beta) * 1.03)
        design_vars[2] = 0.11  # * (beta * 1.05  + (1 - beta) * 1.05)
        design_vars[3] = 23.   # * (beta * 1.025 + (1 - beta) * 1.01)
