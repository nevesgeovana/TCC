...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      75., (65.0, 85.0),     100.,       Units.meter**2],
        ['aspect_ratio',    9.5,     (7.6, 9.8),  100.0,           Units.less],
        # ['taper_ratio',  0.3275, (0.2875, 0.4275),   1.,           Units.less],
        ['t_c_ratio',      0.13,   (0.09, 0.15),     1.,           Units.less],
        ['sweep_angle',    28.,   (18.0, 30.0),  100.0,            Units.deg],
        ['cruise_range',  1122., (800., 1350.), 10000.0, Units.nautical_miles],
