...
def main():
    ...
    for i, beta in enumerate(betas):
        ...
        design_vars[-1] = beta
        design_vars[0] = 72.5382 # 72.72 * (beta * 1.025 + (1 - beta) * 0.97)
        design_vars[1] = 9.374   # 8.6   * (beta * 1.15  + (1 - beta) * 1.03)
        design_vars[2] = 0.1155  # 0.11  * (beta * 1.05  + (1 - beta) * 1.05)
        design_vars[3] = 23.4025 # 23.   * (beta * 1.025 + (1 - beta) * 1.01)
...
def setup():
    ...
    problem.inputs = np.array([
        ...
        ['cruise_range',  1103.2, (800., 1350.), 10000.0, Units.nautical_miles],
