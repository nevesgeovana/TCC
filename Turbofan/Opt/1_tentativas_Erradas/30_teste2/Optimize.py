...
def main():
    ...
    print 'Sweep Ang   = ', last_inputs[3]*30.
    # ------------------------------------------------------------------
    # Pareto
    ...
    for i, beta in enumerate(betas):
        ...
        problem.beta = beta
        design_vars[0] = 75.18428967
        design_vars[1] = 9.8
        design_vars[2] = 0.118147107
        design_vars[3] = 28.78362065
        ...
        # output = pyopt_setup.Pyopt_Solve(problem, solver='SNOPT')
...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',       75.18428967,  (65.0, 80.0),     75.,       Units.meter**2],
        ['aspect_ratio',    9.8,    (7.6, 9.8),     9.8,           Units.less],
        ['t_c_ratio',      0.118147107,  (0.09, 0.15),    0.13,           Units.less],
        ['sweep_angle',     28.78362065,  (18.0, 30.0),    30.0,            Units.deg],
        ['cruise_range',  1114.2498252, (800., 1350.),  1120.0, Units.nautical_miles],
