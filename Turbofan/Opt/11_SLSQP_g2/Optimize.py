...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',      72.69071389,  (65.0, 80.0),       75.,       Units.meter**2],
        ['aspect_ratio',           9.8,    (7.6, 9.8),       9.8,           Units.less],
        ['t_c_ratio',      0.122660243,  (0.09, 0.15),      0.13,           Units.less],
        ['sweep_angle',            30.,  (18.0, 30.0),      30.0,            Units.deg],
        ['cruise_range', 1119.35367049, (1000., 1160.),   1130.0, Units.nautical_miles],
        ['MTOW',         37374.9406952, (35000., 39000.), 37200.,             Units.kg],
        ['MZFW_ratio',     0.818930696, (0.7, 0.9),          0.9,           Units.less],
    ])
