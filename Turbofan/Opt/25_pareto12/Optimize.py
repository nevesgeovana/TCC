...
def main():
    ...
    for i, beta in enumerate(betas):
        ...
        design_vars[-1] = beta
        design_vars[0] = 68.619613
        design_vars[1] = 9.518863
        design_vars[2] = 0.14258078
        design_vars[3] = 30.491277
...
def setup():
    ...
    problem.inputs = np.array([
        ['wing_area',     68.619613, (65.0, 85.0),     100.,       Units.meter**2],
        ['aspect_ratio',    9.518863,     (7.6, 10.6),  100.0,           Units.less],
        # ['taper_ratio',  0.3275, (0.2875, 0.4275),   1.,           Units.less],
        ['t_c_ratio',      0.14258078,   (0.09, 0.15),     1.,           Units.less],
        ['sweep_angle',    30.491277,   (18.0, 35.0),  100.0,            Units.deg],
        ['cruise_range',  1112.73390627, (800., 1350.), 10000.0, Units.nautical_miles],
